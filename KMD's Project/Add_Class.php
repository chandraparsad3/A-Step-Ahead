...
<body>
   ...
   <div class="main-panel">
    ...
    <fieldset>
        ...
        <form action="Add_Class.php" method="post" enctype="multipart/form-data" id="form1">
                    ...
                    <tr>
                        <td>
                            <?php
                               ...
                               $num_results=mysqli_num_rows($rets);
                            if ($num_results==0)
                            {
                            ...
                            else
                            {
                                echo "<table width='100%' cellpadding='10' border='1'>";
                                    ...
                                    for ($i=0; $i <$num_results; $i++)
                                    {
                                        ...
                                        echo "<td><a href='EditClass.php?ClassID=$ClassID&Mode=Update'>Edit</a>|<a href='DeleteClass.php?ClassID=$ClassID'>Delete</a></td>";
                                    }
                                echo "</table>";
                            }
                            ?>
