...
?>
 ...
 <head>
    <meta charset="utf-8">
    <title>AstepAhead-Register Student</title>
 ...
 <div class="container-fluid">
   ...
   <form action="Register.php" method="POST">
        ...
        <tr>
   			...
   			<tr>
   				<td></td>
   				<td><input type="submit" name="btnsubmit" class="registerbtn">
   				    <input type="reset" value="clear" class="registerbtn"></td>
   			</tr>   			   			   			   			   			   			
   		</table>
         <div class="container signin">
         <td>Already have an account? <a href="StudentLogin.php">Sign in</a>.</>
         </div> 
    </form>
