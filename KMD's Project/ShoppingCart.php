<?php 
  ...
  if($action=="buy")
  {
    $ClassID=$_GET['txtClassID'];
    $Quantity=1;
    Insert($ClassID,$Quantity);
  }
                        ...
                        <div class="navbar-nav py-0">
                            ...
                            <?php 
                              if(isset($_SESSION['StudentID']))
                              {
                                ...
                                echo "<a href='ShoppingCart.php' class='nav-item nav-link active'>Cart</a>";
                              }
                            ?>
                        </div>
                        <?php
      ...
      <td>
        ...
        <?php 
            if(! isset($_SESSION['ShoppingCart']))
            {
              ...
              echo "<p>Total Amount: 0 Kyats</p>";
              echo "<a href='ClassDisplay.php'>Class Display</a>";
            }
         ?>
      </td>
    </tr>
    ...
    <?php 
          ...
          for($i=0;$i<$size;$i++)
          {
            ...
            <tr>
              ...
              <td>
                <?php echo $_SESSION['ShoppingCart'][$i]['ClassID']; ?>
              </td>
              <td>
                <?php echo $_SESSION['ShoppingCart'][$i]['Category']; ?>
              </td>
              <td>
                <?php echo $_SESSION['ShoppingCart'][$i]['CourseName']; ?>
              </td>
              <td>
                <?php echo $_SESSION['ShoppingCart'][$i]['Lecturer']; ?>
              </td>
              <td>
                <?php echo $_SESSION['ShoppingCart'][$i]['StartDate']; ?>
              </td>
              <td>
                <?php echo $_SESSION['ShoppingCart'][$i]['EndDate']; ?>
              </td>
              <td>
                <?php echo $_SESSION['ShoppingCart'][$i]['Time']; ?>
              </td>
              <td>
                <?php echo $_SESSION['ShoppingCart'][$i]['ETime']; ?>
              </td>

              <td>
                <?php echo $_SESSION['ShoppingCart'][$i]['Quantity']*$_SESSION['ShoppingCart'][$i]['Fees']; ?>
              </td>
              <td>
                <a href="ShoppingCart.php?action=remove&ClassID=<?php echo $_SESSION['ShoppingCart'][$i]['ClassID']; ?>">Remove</a>
              </td>
            </tr>
            <?php 
          }
      ...
      <td colspan="10" align="right">
        <table>
          <tr>
            <td>
            <br>
            <h1>Total Amount&nbsp;&nbsp;:<?php echo Get_TotalAmount(); ?>Kyats</h1>
            <h1>Total Quantity&nbsp;: <?php echo Get_TotalQuantity();  ?></h1>
            <hr>
            <a href="ClassDisplay.php">Class Display</a>&nbsp;|
