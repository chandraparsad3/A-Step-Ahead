...
<head>
    <meta charset="utf-8">
    <title>A Step Ahead's Teachers</title>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href="teacher.php" class="nav-item nav-link active">Teachers</a>
    ...
    <fieldset>
        ...
        <div class="container pt-5 pb-3">
          <div class="text-center mb-5">
            ...
            <div class="row">
               <?php 
                 $searchdata1="SELECT * FROM Lecturer ORDER BY Name";
                 $ret1=mysqli_query($connection,$searchdata1);
                 $num_result1=mysqli_num_rows($ret1);
                 for($c=0; $c<$num_result1;$c+=3)
                 {
                    $Lect1="SELECT * FROM Lecturer order by Name LIMIT $c,3";
                    $retp1=mysqli_query($connection,$Lect1);
                    ...
                    <td>
                     ...
                     <div class="team-item rounded overflow-hidden mb-2">
                       ...
                       <br>
                       <b><?php echo $row1['Degree']; ?></b>
                       <br>
                       <b><?php echo $row1['Mail']; ?></b>                                             
                     </div>
                     </div>
                     </div>
                 </td>
